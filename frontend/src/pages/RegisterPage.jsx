    ...
    <div className="flex min-h-screen bg-background w-full">
      ...
      <div className="w-full lg:w-1/2 flex-shrink-0 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-[500px]">
          ...
          <div className="mb-10">
            <h2 className="font-headline-lg text-on-surface mb-2">Create an account</h2>
            <p className="text-text-secondary font-body-md">Enter your details to get started</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                <label className="block font-label-caps text-text-secondary mb-2">FULL NAME</label>
                <input 
                  type="text" 
                  required
                  value={name}
              ...
              <div>
                <label className="block font-label-caps text-text-secondary mb-2">EMAIL ADDRESS</label>
                <input 
                  type="email" 
                  required
                  value={email}
                  ...
                  className="w-full bg-bg-surface border border-border-subtle rounded py-3 px-4 font-body-md text-on-surface focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors placeholder:text-text-secondary/50"
                  placeholder="sarah@transitops.io"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                <label className="block font-label-caps text-text-secondary mb-2">DEPOT NAME</label>
                <input 
                  type="text" 
                  required
                  value={depotName}
